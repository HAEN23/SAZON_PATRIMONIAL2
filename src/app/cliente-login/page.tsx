...
import styles from "./cliente-login.module.css";
...
export default function ClienteLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Asumiendo un endpoint de login para clientes.
      // Deberás ajustar este endpoint a tu API real.
      const response = await fetch(
        "http://52.23.26.163:7070/auth/login-cliente",
        {
          method: "POST",
